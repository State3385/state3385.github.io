...
<ol>
  ...
  <li>Players cannot leave NAP, break rules, and rejoin NAP. Any attempt to bypass rules will lead to punishment.</li>
...
<ol start="17">
  ...
  <li>No alliances can control duplicate facilities.</li>
...
<h3>전투 규칙</h3>
<ol>
  <li>NAP 연맹 및 그들의 아카데미, 도시, 연맹본부, 깃발에 대한 공격, 집결, 정찰을 금지합니다.</li>
  <li>지정된 이벤트(예: 전군참전) 외에는 자원채집지 공격을 금지합니다.</li>
  <li>시설 전투 중 제3자의 개입(예: 연맹을 바꿔서 지원)이나 도시 공격은 금지됩니다.</li>
  <li>지정된 NAP 연맹만이 요새나 성을 공격할 수 있습니다. 다른 플레이어나 연맹은 손대면 안 됩니다.</li>
  <li>요새나 성채에 대한 단독 공격은 금지됩니다.</li>연맹에서의 축출 또는 NAP 자체에서의 완전한 추방이 이뤄질 수 있습니다.</li>
  <li>NAP를 나간 후 규칙을 어기고 다시 가입하는 것은 허용되지 않으며, 규칙을 우회하려는 모든 시도는 처벌받습니다.</li>
  <li>NAP에서 특정 플레이어에 대한 처벌을 결정한 경우, 해당 플레이어가 속한 동맹은 이에 따라야 하며, 그렇지 않으면 NAP 회원 자격을 상실할 수 있습니다.</li>
</ol>
<h3>연맹 규칙</h3>
<ol start="12">
  <li>각 NAP 연맹은 오직 하나의 아카데미 연맹만 지정할 수 있습니다.</li>
  <li>SvS 지정 연맹은 NAP의 보호를 받습니다.</li>
  <li>NAP 연맹으로부터의 플레이어 스카우팅은 금지됩니다.</li>
  <li>NAP에는 상위 8개 연맹과 각 연맹의 아카데미, 그리고 SvS 연맹이 포함됩니다.</li>
  <li>각 NAP 연맹은 전체 연맹을 대표해 투표할 대표자를 1명 지정해야 합니다.</li>
</ol>
<h3>시설 및 깃발 규칙</h3>
<ol start="17">
  <li>요새 및 성채의 순환 스케줄을 반드시 따르십시오.</li>
  <li>요새 및 성채는 SvS 준비 단계 이후 준비 순위에 따라 분배됩니다.</li>
  <li>시설은 자유롭게 경쟁할 수 있는 자원입니다. 연맹은 공정하게 싸우거나 나눠 가질 수 있습니다. 4레벨 공격/방어 시설 및 병력 행진 시설은 SvS 전에 SvS 연맹에 먼저 할당됩니다.</li>
  <li>동일한 유형의 시설을 중복으로 통제하는 것은 불가능합니다.</li>
  <li>다른 연맹이 시설에 접근하지 못하도록 막는 깃발을 설치하지 마십시오.</li>
</ol>
<h3>투표 및 운영 규칙</h3>
<ol start="22">
  <li>NAP의 모든 결정은 아카데미/농장은 제외하고 다수결로 결정됩니다.</li>
...
<ol>
  ...
  <li>玩家不能先离开NAP、违反规则后再重新加入NAP，任何试图规避规则的行为都会受到惩罚。</li>
...
<ol>
  ...
  <li>Oyuncular NAP’ten ayrılıp kuralları çiğneyip tekrar NAP’e katılamaz. Kuralları atlatmaya yönelik her girişim cezalandırılır.</li>
...
<ol start="17">
  ...
  <li>Hiçbir ittifak aynı türden birden fazla tesisi kontrol edemez.</li>
...
<ol>
  ...
  <li>Un joueur ne peut pas quitter le NAP, enfreindre les règles, puis y revenir. Toute tentative de contournement des règles entraînera une punition.</li>
...
<ol start="17">
  ...
  <li>Aucune alliance ne peut contrôler plusieurs installations du même type.</li>
...
<ol>
  ...
  <li>Los jugadores no pueden salir del NAP, romper reglas y volver a unirse. Cualquier intento de eludir las reglas será castigado.</li>
...
<ol start="17">
  ...
  <li>Ninguna alianza puede controlar instalaciones duplicadas.</li>
...
<ol>
  ...
  <li>لا يمكن للاعبين مغادرة NAP، خرق القواعد، ثم العودة مجددًا. أي محاولة للتحايل ستؤدي إلى العقوبة.</li>
...
<ol start="17">
  ...
  <li>لا يمكن لأي تحالف السيطرة على منشآت مكررة من نفس النوع.</li>
